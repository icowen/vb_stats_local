...
class TeamStatsPage extends StatefulWidget {
  ...
  const TeamStatsPage({super.key, required this.practice});
                        ...
                        child: Column(
                          children: [
                            ...
                            DataTable(
                              ...
                              rows: _practicePlayers.map((player) {
                                return DataRow(
                                  cells: [
                                    DataCell(
                                      Padding(
                            ...
                            DataTable(
                              ...
                              rows: _practicePlayers.map((player) {
                                final playerEvents = _teamEvents
                                    .where((e) => e.player.id == player.id)
                                    .toList();
                                final servingStats = _getPlayerServingStats(
                                  playerEvents,
                                );
                            ...
                            DataTable(
                              ...
                              rows: _practicePlayers.map((player) {
                                final playerEvents = _teamEvents
                                    .where((e) => e.player.id == player.id)
                                    .toList();
                                final passingStats = _getPlayerPassingStats(
                                  playerEvents,
                                );
                                    ...
                                    DataCell(
                                      Padding(
                                        ...
                                        child: SizedBox(
                                          width: double.infinity,
                                          child: Text(
                                            '${passingStats['average'].toStringAsFixed(2)}',
                                            textAlign: TextAlign.center,
                                            overflow: TextOverflow.ellipsis,
                                          ),
                                        ),
                            ...
                            DataTable(
                              ...
                              rows: _practicePlayers.map((player) {
                                final playerEvents = _teamEvents
                                    .where((e) => e.player.id == player.id)
                                    .toList();
                                final attackingStats = _getPlayerAttackingStats(
                                  playerEvents,
                                );
                                final hitPercentage =
                                    attackingStats['total']! > 0
                                    ? (attackingStats['kill']! -
